  ...
  for ( cell in 1:nrow(Data_Frame)) {
    ...
    if ((Data_Frame$Reduced_Activity_One[cell]=="SA" & Data_Frame$Reduced_Activity_Two[cell]=="R") | (Data_Frame$Reduced_Activity_One[cell]=="SA" & Data_Frame$Reduced_Activity_Two[cell]=="W")){
      ...
      if (Title!="Day4"){
        ...
        geom_point(aes(y=factor(1), colour=Reduced_Activity_One), shape=15, size=10)+
        geom_point(aes(y=1.12, colour=Reduced_Activity_Two), shape=15, size=10)+
        geom_point(aes(y=1.24, colour=Reduced_Activity_Three), shape=15, size=10)+
