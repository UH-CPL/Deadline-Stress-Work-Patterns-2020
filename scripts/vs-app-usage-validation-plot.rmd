...
# 
# check_data<- subset(DF, Participant_ID=="T015" & Day=="Day1" & Activities_QC2=="Other Activities")
# unique(check_data$Activities_QC1)
# tab_activities<-table(check_data$Activities_QC2)
# tab_activities
```
...
for (i in 1:n) {
  ...
  y_max=15000
      ...
      for (j in 1:m) {
        ...
        title=levels(D_id)[j]
        fig<-Plot2(DF_Sub_Day,  DF_Sub_Day$Reduced_Application, DF_Sub_Day$Reduced_Activity_One, DF_Sub_Day$Sinterface_Time,DF_Sub_Day$Participant_ID, title, y_max)
