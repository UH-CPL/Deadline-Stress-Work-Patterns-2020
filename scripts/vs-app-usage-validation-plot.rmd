...
```{r}
DF_Sub1<-subset(DF, Participant_ID=="T007" & DF$Treatment=="WS" & Day=="Day2" & DF$Activities_QC2=="Computer Working" & DF$Reduced_Ontology_One!="SA")
#DF_Sub1<-subset(DF, Participant_ID=="T005" & DF$Treatment=="WS" & Day=="Day4")
unique(DF_Sub1$Application)
tab_activities <- table(DF_Sub1$Application_QC1)
tab_activities
#DF_Sub1$Application_QC1
```
...
DF=DF %>% mutate(Modified_App = ifelse(Application_QC1 == "Microsoft Word" | Application_QC1 == "Microsoft AutoUpdate" |Application_QC1 == "Microsoft PowerPoint" | Application_QC1 == "AdobeAcrobat"| 
                                                  ...
                                                  Application_QC1 == "POWERPNT"|Application_QC1 == "EXCEL"|Application_QC1=="MendeleyDesktop","Document Apps", 
                                ...
                                ifelse(Application_QC1=="Photos"| Application_QC1=="iTunes"|Application_QC1=="Spotify" | Application_QC1=="App Store", "Entertaining Apps",
                                ...
                                ifelse(Application_QC1=="JavaApplication_QC1Stub"| Application_QC1=="RStudio" | Application_QC1=="Osascript" | Application_QC1=="Terminal" | Application_QC1=="Console" 
                                                 |Application_QC1=="ATLAS.ti" |Application_QC1=="TeamViewer" | Application_QC1 == "Idle", "Programming Apps",
                                       
                                ifelse(Application_QC1=="QQ"| Application_QC1=="Skype" |Application_QC1=="FaceTime"| Application_QC1=="Slack" |Application_QC1=="WeChat"| Application_QC1=="Messages"  , "Virtual Communication Apps",
...
```{r, echo=FALSE}
plot_location<-"C:/Users/soton/Documents/R/DeadlineProject/Plots/AppsActivity/Version2/"
plot_list<-list()
...
for (i in 1:n) {
      ...
      full_path<-paste(plot_location,levels(sid)[i],".pdf",sep="")
