...
read_data <- function() {
  ...
  rr_df <<- custom_read_csv(file.path(physiological_data_path, qc1_rr_mean_v1_file_name)) %>% 
    rename(RR=RR_Mean)
  ...
  transformed_mean_df <- custom_read_csv(file.path(physiological_data_path, qc1_transformed_mean_v1_file_name)) %>% 
    rename(PP_Log=PP,
           E4_HR_Log=E4_HR,
           E4_EDA_Log=E4_EDA,
           iWatch_HR_Log=iWatch_HR)
  
  transformed_rb_mean_df <<- transformed_mean_df %>% 
    filter(Treatment=='RB') %>% 
    mutate(Day=relevel(factor(Day, ordered=F), ref='Day4'))
  ...
  normalized_mean_df <- custom_read_csv(file.path(physiological_data_path, qc1_normalized_mean_v1_file_name))
  physiological_questionnaire_df <<- merge(normalized_mean_df, activity_state_nasa_df, by=c('Participant_ID', 'Day'))
  ...
  physiological_questionnaire_df <<- physiological_questionnaire_df %>% 
    ...
    merge(transformed_mean_df, by=c('Participant_ID', 'Day', 'Treatment')) %>%
    merge(rr_df, by=c('Participant_ID', 'Day', 'Treatment')) %>%
...
\newpage
Linear Model - 1.1 -> Random Effect
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
...
\newpage
Linear Model - 1.2 -> Random Effect
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
...
\newpage
Linear Model - 1.3 -> Random Effect
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
...
\newpage
Linear Model - 1.4 -> Random Effect
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
...
\newpage
Linear Model - 1.5 -> Random Effect
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
model = lme(RR ~ Day + NASA_summative, 
            data=physiological_questionnaire_df,
            random=~1|Participant_ID,
            na.action = na.omit)
print(summary(model))
...
\newpage
Linear Model - 2.1 -> Resting Baseline
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
model = lme(PP_Log ~ Day,
            data=transformed_rb_mean_df,
            random=~1|Participant_ID,
            na.action = na.omit)
print(summary(model))
print(anova(model))
...
\newpage
Linear Model - 2.2 -> Resting Baseline
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
model = lme(E4_HR_Log ~ Day, 
            data=transformed_rb_mean_df,
            random=~1|Participant_ID,
            na.action = na.omit)
print(summary(model))
...
\newpage
Linear Model - 2.3 -> Resting Baseline
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
model = lme(E4_EDA_Log ~ Day, 
            data=transformed_rb_mean_df,
            random=~1|Participant_ID,
            na.action = na.omit)
print(summary(model))
...
\newpage
Linear Model - 2.4 -> Resting Baseline
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
model = lme(iWatch_HR_Log ~ Day,
            data=transformed_rb_mean_df,
            random=~1|Participant_ID,
            na.action = na.omit)
print(summary(model))
...
\newpage
Linear Model - 2.5 -> Resting Baseline
------------------------------
```{r echo=FALSE, warning = FALSE, message = FALSE}
model = lme(RR ~ Day,
            data=rr_rb_df,
