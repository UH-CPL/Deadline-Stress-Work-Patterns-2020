    ...
    for (day in day_list) {
      ...
      for (treatment in unique(day_df$Treatment)) {
        ...
        if (treatment=='WS') {
          ...
          print(unique(activity_df$Activity_One))
          ...
          # 
          # # print(unique(activity_df$Activity_One))
          # # print(unique(activity_df$Activity_Two))
          # # print(unique(activity_df$Activity_Three))
          # 
          # #######################################################################################################
          # #######################################################################################################
          # # Ontology_Color <- c(
          ...
          # #   scale_color_manual(values = Ontology_Color, limits = c("CR", "CW", "Out", "SA", "SP", "I", "")) +
          # #   guides(colour = guide_legend(nrow = 1))
          # #######################################################################################################
          # #######################################################################################################
          # 
