...
color_day<-c("Day1"="orange", "Day2"="red", "Day3"= "green", "Day4"="blue")
 mean_line<-function(df, y_title, x_title, yminlim, ymaxlim){
  ...
  scale_color_manual(values = color_day, limits = c("orange", "red", "green", "blue"), labels= c("Day1", "Day2", "Day3", "Day4"))+
     ...
     theme_bw()+
   theme(text = element_text(color = "black"))+theme(legend.title = element_blank())+
...
# subject_title="T013"
# DF_Sub_Day<-subset(DF, Participant_ID=="T013")
...
plot_location<-"C:/Users/soton/Documents/R/DeadlineProject/Plots/PhysiologicalPlots/Version2/"  
  global_legend<-NULL
...
for(channel in channel_list){
  ...
  if(channel=="EDA"){
      ...
      y_min=0.01
      y_max=0.80
      yaxis_title = expression(paste('EDA [', mu, 'S]'))
