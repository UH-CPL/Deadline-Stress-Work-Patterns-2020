...
# data_file_name<-'segment_df.csv'
# curated_data_dir <- file.path(root_dir, 'curated-data/physiological-data')
# segment_df<-read.csv(file.path(data_dir,data_file_name),stringsAsFactors = FALSE)
# 
# Data1$Segment= segment_df$Segment
```
...
segment_df$Segment<-NULL
# segment_df$Segments_Activity<-NULL
...
Merged_Data = Merged_Data[Merged_Data$Length_Break > 7, ]
