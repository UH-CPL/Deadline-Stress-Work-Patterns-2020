...
Data <- subset(Data , select = -c(Participant_ID, Treatment, F_Angry, F_Disgusted, F_Afraid, F_Sad, F_Surprised, F_Binary, FSum_Binary, F_Happy, F_Neutral, N_TD, N_E, N_F, Out, T_RW_APPS, T_EA, T_PA, T_VC, AB, B5_O, B5_N))
