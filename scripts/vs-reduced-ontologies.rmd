...
```{r}
#DF<-subset(DF, Participant_ID=="T009" & DF$Treatment=="WS")
legend_heatmap<-NULL
legend_timeline<-NULL
plot_location<-"C:/Users/soton/Documents/R/DeadlineProject/Plots/Combined/Version8/"
...
Draw_Timeline_Day<-function(Data_Frame, Title){
  for ( cell in 1:nrow(Data_Frame)) {
    ...
    if ((Data_Frame$Reduced_Ontology_One[cell]=="SA" & Data_Frame$Reduced_Ontology_Two[cell]=="R") | (Data_Frame$Reduced_Ontology_One[cell]=="SA" & Data_Frame$Reduced_Ontology_Two[cell]=="W")){
      ...
      Ontology_Color <- c( "R" = "green4", "W" = "blue",  "I" = "Orange", "Out" = "white", "SP" = "red", "SA" = "magenta", "nil"="gray92")
      ...
      if (Title!="Day4"){
        ...
        theme(text = element_text(size=12 ,color = "black"),plot.title = element_text(hjust = 0.5), panel.border = element_blank(), 
        ...
        scale_color_manual(values = Ontology_Color, limits = c("R", "W", "I", "Out", "SP",  "SA"))+
...
```{r}
  DF_Sub1<-subset(DF, Participant_ID=="T009" & DF$Treatment=="WS" & Day=="Day3")
```
...
DF_Sub_Day<-subset(DF, Participant_ID=="T007" & Day=="Day2" & Treatment=="WS")
